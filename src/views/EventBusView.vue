...
<template>
 <div>
  <p class="mx-auto max-w-xl text-center">
   Here we're using <span class="imp-txt">Event Bus</span> to send a random number as (index) to all
   children and the child will be happy if the random index equal to child's index or we can just
