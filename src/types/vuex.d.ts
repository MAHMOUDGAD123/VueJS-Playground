...
import type { _Store, StoreRootGettersResolved, StoreRootStateResolved } from 'vuex';
...
declare module 'vuex' {
  // Custom Types Start (you can add store root data here 😎)
  // ---------------------------------------------------------------
   ...
   * ```
   */
  interface StoreActionRecord<Payload, Return, RootLevel extends boolean = false> {
    payload: Payload;
    return: Return;
    root: RootLevel;
  }

  type ModuleNamesGeneric = 'root' | ModuleNames;
  ...
  declare class _Store<RootState = StoreRootStateResolved, RootGetters = StoreRootGettersResolved> {
     ...
     */
    hotUpdate(options: {
      actions?: _ActionTree<RootState, RootGetters, StoreRootActions>;
      mutations?: _MutationTree<RootState, StoreRootMutations>;
      getters?: _GetterTree<RootState, RootGetters, RootGetters>;
      modules?: Required<StoreRootModules>;
    }): void;
  }
   ...
   */
  function createStore<RootState = StoreRootState, RootGetters = StoreRootGetters>(
   ...
   */
  function useStore<RootState = StoreRootStateResolved, RootGetters = StoreRootGettersResolved>(
  ...
  interface _StoreOptions<RootState, RootGetters> {
    ...
    actions?: _ActionTree<StoreRootStateResolved, StoreRootGettersResolved, StoreRootActions>;
    mutations?: _MutationTree<StoreRootStateResolved, StoreRootMutations>;
    modules?: StoreRootModules;
   ...
   * ```ts
   *  getterCallback(state, [`settersParameter`], rootState, rootGetters): any
   * ```
   */
  ...
  type _ActionContextDispatch<ModuleName extends ModuleNamesGeneric> = <
  ...
  type _ActionContextCommit<ModuleName extends ModuleNamesGeneric> = <
    Mutation extends
  ...
  type _ActionTree<
    ...
    ModuleName extends ModuleNamesGeneric = 'root',
  > = {
  ...
  interface _Dispatch {
    ...
    <Payload extends _Payload, A extends keyof StoreRootActionsResolved>(
      ...
      options?: DispatchOptions,
    ): Promise<StoreRootActions[A]['return']>;
  }
  ...
  type StoreRootStateResolved = StoreRootState & {
    [K in keyof Required<StoreRootModules>]: ResolveModuleState<Required<StoreRootModules>[K]>;
  };
   ...
   * ```
   */
  type ModulesStateMapResolved = BuildModulesStateMap<Required<StoreRootModules>> & {
  ...
  type StoreRootGettersResolved = StoreRootGetters &
    UnionToIntersection<
      {
        [K in keyof Required<StoreRootModules>]: Required<StoreRootModules>[K] extends _Module<
          any,
          infer Mode,
          any,
          any,
        ...
        >
          ? ResolveModuleGetters<
              Required<StoreRootModules>[K],
              Mode extends 'isolated' ? K & string : ''
            >
          : {};
      }[keyof Required<StoreRootModules>]
    >;
  ...
  type BuildModulesGetterMap<
    Modules,
    ParentGetters = StoreRootGetters,
  ...
  type StoreRootMutationsResolved = StoreRootMutations &
    UnionToIntersection<
      {
        [K in keyof Required<StoreRootModules>]: Required<StoreRootModules>[K] extends _Module<
          any,
  ...
  type BuildModulesMutationMap<
    Modules,
    ParentMutations = StoreRootMutations,
    HasRootAccess extends boolean = true, // Track root access explicitly
    CurrentPath extends string = '',
  > = Modules extends undefined
    ? {}
  ...
  type StoreRootActionsResolved = StoreRootActions &
    UnionToIntersection<
      {
        [K in keyof Required<StoreRootModules>]: Required<StoreRootModules>[K] extends _Module<
          any,
  ...
  type BuildModulesActionMap<
    Modules,
    ParentActions = StoreRootActions,
   ...
   */
  type ModulesInfoNameMap = ExtractModulesInfoNameMap<Required<StoreRootModules>>;
  ...
  type ExtractModulesInfoNamespaceMap<
    Modules,
    ParentPath extends string = '',
    ParentName extends string | null = null,
    ParentMode extends ModuleMode = 'default',
  ...
  type ModulesInfoNamespaceMap = ExtractModulesInfoNamespaceMap<Required<StoreRootModules>>;
  ...
  // Keys
  type Namespaces = ModuleNames;
  type StateKeys = keyof StoreRootStateResolved;

  // State Mappers
  interface _StateMapper {
    <Key extends StateKeys>(map: Key[]): { [K in Key]: _Computed<StoreRootStateResolved[K]> };
    ...
    >(
      ...
      [K in keyof Map]: Map[K] extends StateKeys
  ...
  interface _StateMapperWithNamespace {
    <Namespace extends Namespaces, Key extends keyof ModulesStateMapResolved[Namespace]>(
      namespace: Namespace,
      map: Key[],
    ): { [K in Key]: _Computed<ModulesStateMapResolved[Namespace][K]> };

    <
      Namespace extends Namespaces,
      Map extends Record<
        string,
        | keyof ModulesStateMapResolved[Namespace]
        | ((
            this: _CustomVue,
            state: ModulesStateMapResolved[Namespace],
            getters: ModulesGettersMapResolved[Namespace],
          ) => any)
      >,
    >(
      namespace: Namespace,
      ...
      [K in keyof Map]: Map[K] extends ModulesStateMapResolved[Namespace]
        ? _Computed<StoreRootStateResolved[Namespace][Map[K]]>
        : _InlineComputed<Map[K]>;
    };
  }
